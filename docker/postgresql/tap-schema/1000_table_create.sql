...
INSERT
  ...
  ('tap_schema.obscore','s_xel1','obscore:Char.SpatialAxis.numBins1','meta.number',null,'','double',null,null,1,0,1,28,null),
  ('tap_schema.obscore','s_xel2','obscore:Char.SpatialAxis.numBins2','meta.number',null,'','double',null,null,1,0,1,29,null),
  ...
  ('tap_schema.obscore','t_xel','obscore:Char.TimeAxis.numBins','meta.number',null,'number of time axis bins','double',null,null,1,1,1,28,null),
  ...
  ('tap_schema.obscore','em_xel','obscore:Char.SpectralAxis.numBins','meta.number',null,'number of spectral axis bins','double',null,null,1,1,1,27,null),
  ...
  ('tap_schema.obscore','proposal_id','obscore:Provenance.Proposal.identifier','meta.id;obs.proposal',null,'proposal id','char','128*',null,1,0,1,25,null),
  ...
  ('tap_schema.obscore','dataproduct_subtype','obscore:ObsDataset.dataProductSubtype','meta.id',null,'subtype of product','char','128*',null,1,0,1,26,null),
  ...
  ('tap_schema.obscore','pol_xel','obscore:Char.PolarizationAxis.numBins','meta.number',null,'','double',null,null,1,0,1,30,null),
